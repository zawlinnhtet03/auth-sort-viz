...
public class ButtonPanel extends JPanel {
    ...
    public ButtonPanel(SortButtonListener listener) {
        ...
        initButtons(buttons[6], "exit_button", 6);
    ...
    // Initialize buttons with icons and mouse listeners
    private void initButtons(JLabel button, String name, int id) {
        button.setIcon(new ImageIcon(getClass().getResource(String.format("buttons/%s.png", name))));
        button.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseEntered(MouseEvent e) {
                button.setIcon(new ImageIcon(getClass().getResource(String.format("buttons/%s_entered.png", name))));
            }
            ...
            public void mousePressed(MouseEvent e) {
                if (e.getButton() == MouseEvent.BUTTON1) { // Check if left mouse button is pressed
                    button.setIcon(new ImageIcon(getClass().getResource(String.format("buttons/%s_pressed.png", name))));
                }
            }

            @Override
            public void mouseReleased(MouseEvent e) {
                if (e.getButton() == MouseEvent.BUTTON1) { // Check if left mouse button is released
    ...
    // Interface for sorting button clicks
